//import sha256 node module so we can hash everything
...
class Block {
  ...
  calculateHash(){
    return SHA256(this.index + this.timestamp + this.previousHash + JSON.stringify(this.data) + this.nonceVal).toString();
  }
